package com.example.poke_asimplemessenger.utilities;
...
public class Constants {
    ...
    public static final String KEY_PREFERENCE_NAME = "pokeAppPreference";
    ...
    public static HashMap<String, String> getRemoteMessageHeaders(){
        if( remoteMessageHeaders == null ){
            ...
            remoteMessageHeaders.put(
                    ...
                    "bb04989aa8d27c5d6537d3e08a98b79a7e19f929"
            );
            remoteMessageHeaders.put(
